...
(function(g, e) {
    ...
    for (var b = document.createElement("div"), b = b.style, d = !1, c = ["-webkit-", "-moz-", "-o-", "-ms-", "-khtml-"], f = ["Webkit", "Moz", "O", "ms", "Khtml"], i = "", h = 0; h < f.length; h++)
        if ("" === b[f[h] + "Transition"]) {
            d = f[h] + "Transition";
            i = c[h];
            break
    ...
    $widgetkit.support = {
        transition: d,
        css3d: d && "WebKitCSSMatrix" in window && "m11" in new WebKitCSSMatrix && !navigator.userAgent.match(/Chrome/i),
        canvas: function() {
    ...
    $widgetkit.css3 = function(a) {
        a = a || {};
        a.transition && (a[i + "transition"] = a.transition);
        a.transform && (a[i + "transform"] = a.transform);
        a["transform-origin"] && (a[i + "transform-origin"] = a["transform-origin"]);
        return a
    };
    b = null
})(jQuery, window);
(function(g) {
    g.browser.msie && 9 > parseInt(g.browser.version) && (g(document).ready(function() {
        g("body").addClass("wk-ie wk-ie" + parseInt(g.browser.version))
...
(function(g, e) {
    e.$widgetkit.trans = {
        ...
        get: function(a) {
            ...
            return this.printf("" + this.__data[a], b)
        },
        printf: function(a, b) {
            if (!b) return a;
            var d = "",
            ...
            for (var f = 0; f < b.length; f++) c[f].lastIndexOf("%") == c[f].length - 1 && f != b.length - 1 && (c[f] += "s" + c.splice(f + 1, 1)[0]), d += c[f] + b[f];
            return d + c[c.length -
                1]
        }
    }
...
(function(g) {
    ...
    g.extend(g.easing, {
        ...
        swing: function(e, a, b, d, c) {
            return g.easing[g.easing.def](e, a, b, d, c)
        },
        ...
        easeInElastic: function(e, a, b, d, c) {
            ...
            if (1 == (a /= c)) return b + d;
            f || (f = 0.3 * c);
            g < Math.abs(d) ? (g = d, e = f / 4) : e = f / (2 * Math.PI) * Math.asin(d / g);
            return -(g * Math.pow(2, 10 * (a -= 1)) * Math.sin((a * c - e) * 2 * Math.PI / f)) + b
        },
        easeOutElastic: function(e, a, b, d, c) {
            ...
            f || (f = 0.3 * c);
            g < Math.abs(d) ? (g = d, e = f / 4) : e = f / (2 * Math.PI) * Math.asin(d / g);
            return g * Math.pow(2, -10 * a) * Math.sin((a * c - e) * 2 * Math.PI / f) + d + b
        },
        easeInOutElastic: function(e, a, b, d, c) {
            var e = 1.70158,
                ...
                g = d;
            if (0 == a) return b;
            if (2 == (a /= c / 2)) return b + d;
            f || (f = c * 0.3 * 1.5);
            g < Math.abs(d) ? (g = d, e = f / 4) : e = f / (2 * Math.PI) * Math.asin(d / g);
            return 1 > a ? -0.5 * g * Math.pow(2, 10 * (a -= 1)) * Math.sin((a * c - e) * 2 * Math.PI / f) + b : 0.5 * g * Math.pow(2, -10 * (a -= 1)) * Math.sin((a * c - e) * 2 * Math.PI / f) + d + b
        },
        easeInBack: function(e, a, b, d, c, f) {
            void 0 == f && (f = 1.70158);
            return d * (a /= c) * a * ((f + 1) * a - f) + b
        },
        easeOutBack: function(e, a, b, d, c, f) {
            void 0 == f && (f = 1.70158);
            return d * ((a = a / c - 1) * a * ((f + 1) * a + f) + 1) + b
        },
        easeInOutBack: function(e, a, b, d, c, f) {
            void 0 == f && (f = 1.70158);
            return 1 > (a /= c / 2) ? d / 2 * a * a * (((f *= 1.525) + 1) * a - f) + b : d / 2 * ((a -= 2) * a * (((f *= 1.525) + 1) * a + f) + 2) + b
        },
        easeInBounce: function(e, a, b, d, c) {
            return d - g.easing.easeOutBounce(e, c - a, 0, d, c) + b
        },
        easeOutBounce: function(e, a, b, d, c) {
            return (a /= c) < 1 / 2.75 ? d * 7.5625 * a * a + b : a < 2 / 2.75 ? d * (7.5625 * (a -= 1.5 / 2.75) * a + 0.75) +
                b : a < 2.5 / 2.75 ? d * (7.5625 * (a -= 2.25 / 2.75) * a + 0.9375) + b : d * (7.5625 * (a -= 2.625 / 2.75) * a + 0.984375) + b
        },
        easeInOutBounce: function(e, a, b, d, c) {
            return a < c / 2 ? 0.5 * g.easing.easeInBounce(e, 2 * a, 0, d, c) + b : 0.5 * g.easing.easeOutBounce(e, 2 * a - c, 0, d, c) + 0.5 * d + b
        }
    })
})(jQuery);
(function(g) {
    function e(a) {
        ...
        a.detail && (f = -a.detail / 3);
        h = f;
        void 0 !== d.axis && d.axis === d.HORIZONTAL_AXIS && (h = 0, e = -1 * f);
        void 0 !== d.wheelDeltaY && (h = d.wheelDeltaY / 120);
        void 0 !== d.wheelDeltaX && (e = -1 * d.wheelDeltaX / 120);
        c.unshift(a, f, e, h);
        return g.event.handle.apply(this, c)
    }
    var a = ["DOMMouseScroll", "mousewheel"];
    g.event.special.mousewheel = {
        setup: function() {
            if (this.addEventListener)
                for (var b = a.length; b;) this.addEventListener(a[--b], e, !1);
            else this.onmousewheel = e
        },
        teardown: function() {
            if (this.removeEventListener)
                for (var b = a.length; b;) this.removeEventListener(a[--b], e, !1);
    ...
    g.fn.uploadOnDrag = function(e) {
        return !g.support.ajaxupload ? this : this.each(function() {
            ...
            a.on("drop", function(a) {
                function c(a, b) {
                    for (var d = new FormData, c = new XMLHttpRequest, f = 0, e; e = a[f]; f++) d.append("files[]", e);
                    for (var h in b.params) d.append(h, b.params[h]);
                    c.upload.addEventListener("progress", function(a) {
                    ...
                    c.addEventListener("loadend", function(a) {
                        b.loadend(a)
                    }, !1);
                    c.addEventListener("error", function(a) {
                        b.error(a)
                    }, !1);
                    c.addEventListener("abort", function(a) {
                        b.abort(a)
                    }, !1);
                    c.open(b.method, b.action, !0);
                    c.onreadystatechange = function() {
                        b.readystatechange(c);
                        if (4 == c.readyState) {
...
(function(b, e, f) {
    function d(d) {
        g.innerHTML = '&shy;<style media="' + d + '"> #mq-test-1 { width: 42px; }</style>';
        h.insertBefore(i, c);
        a = 42 == g.offsetWidth;
        h.removeChild(i);
        return a
    ...
    if (!e.matchMedia || b.userAgent.match(/(iPhone|iPod|iPad)/i)) {
        var a, h = f.documentElement,
            c = h.firstElementChild || h.firstChild,
        ...
        e.matchMedia = function(a) {
            ...
            b = {
                ...
                removeListener: function(a) {
                    for (var b = 0, d = c.length; b < d; b++) c[b] === a && delete c[b]
                }
            };
            e.addEventListener && e.addEventListener("resize", function() {
                j(b)
            }, !1);
            f.addEventListener && f.addEventListener("orientationchange", function() {
                j(b)
            }, !1);
            return b
        }
...
(function(b, e, f) {
    if (!b.onMediaQuery) {
        var d = {},
            j = e.matchMedia && e.matchMedia("only all").matches;
        b(f).ready(function() {
            for (var a in d) b(d[a]).trigger("init"), d[a].matches && b(d[a]).trigger("valid")
        });
        b(e).bind("load", function() {
            for (var a in d) d[a].matches && b(d[a]).trigger("valid")
        });
        b.onMediaQuery = function(a, f) {
            var c = a && d[a];
            c || (c = d[a] = e.matchMedia(a), c.supported = j, c.addListener(function() {
